...
**[API Documentation Link](http://51.20.119.5:8001/api/docs/)**
...
```bash
git clone [https://github.com/YOUR_USERNAME/Agritech-SAAS-Backend.git](https://github.com/YOUR_USERNAME/Agritech-SAAS-Backend.git)
